//! The active document, its revision history, and kernel-validated commits.
...
pub use preview::{DocumentDiff, FeatureChange, TransactionPreview};

use preview::document_diff;
...
mod tests {
    ...
    use cadx_core::diagnostics::{BooleanFailureReason, EdgeModifierFailureReason};
    use cadx_core::domain::SketchPlane;
    use cadx_core::topology::{FaceRef, PrimitiveFace};

    use super::test_support::{TestKernel, create_box, session};
    use super::*;
